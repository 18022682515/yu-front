...
exports.animate = function(ele, options, ...args){
    ...
    return new Promise(res=>{
        ...
        if(getType(options)==='Array'){
            ...
            options = { reverse:false,reverseDelay:false,endClose:false };
        }else{
            options.reverse = options.reverse || false;
            options.reverseDelay = options.reverseDelay || false;
            options.endClose = options.endClose || false;
        }
            ...
            setTimeout(()=>{
                ...
                if(num>len){
                    if(options.reverse){
                        ...
                        options.endClose && (_this.style[tran] = '');
